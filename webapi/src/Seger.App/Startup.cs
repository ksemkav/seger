...
using Seger.App.Middleware;
using Seger.App.Services.Authentication;
using Seger.App.Utils;
using Seger.App.Utils.Localization;
using Seger.Domain;
...
using Seger.App.Settings;
using Seger.Domain.Audit;
...
[assembly: InternalsVisibleTo("Seger.App.Tests")]
            ...
            app.UseSpa(
                spa =>
                {
                    ...
                    if (hostEnvironment.IsDevelopment())
                    {
                        ...
                        // spa.UseProxyToSpaDevelopmentServer("http://localhost:3247/");
                    }
                    else
                    {
