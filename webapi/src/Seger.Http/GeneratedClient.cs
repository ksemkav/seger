...
namespace Seger.Http.Generated
{
    ...
    [System.CodeDom.Compiler.GeneratedCode("NSwag", "13.15.10.0 (NJsonSchema v10.6.10.0 (Newtonsoft.Json v13.0.0.0))")]
    public partial interface IOpenIdAuthorizationClient : IBaseClient
    {
        /// <exception cref="ApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task ExternalCallbackGETAsync(OpenIdAuthorizationClientExternalCallbackGETParametersDto parameters)
        {
            return ExternalCallbackGETAsync(parameters, System.Threading.CancellationToken.None);
        }
        ...
        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task ExternalCallbackGETAsync(string remoteError, string originalQuery, System.Threading.CancellationToken cancellationToken);

        /// <exception cref="ApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task ExternalCallbackPOSTAsync(string remoteError, string originalQuery);
        ...
        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task ExchangeAsync(System.Threading.CancellationToken cancellationToken);

    }

    public partial class OpenIdAuthorizationClientExternalCallbackGETParametersDto
    {
    ...
    public partial class OpenIdAuthorizationClient : BaseClient, IOpenIdAuthorizationClient
    {
        ...
        public OpenIdAuthorizationClient(System.Net.Http.HttpClient httpClient)
        {
            _httpClient = httpClient;
            _settings = new System.Lazy<Newtonsoft.Json.JsonSerializerSettings>(CreateSerializerSettings);
        }
        ...
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task ExternalCallbackGETAsync(string remoteError, string originalQuery)
        {
            return ExternalCallbackGETAsync(remoteError, originalQuery, System.Threading.CancellationToken.None);
        }

        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task ExternalCallbackGETAsync(string remoteError, string originalQuery, System.Threading.CancellationToken cancellationToken)
        {
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/connect/authorize/callback?");
            if (remoteError != null)
            {
            ...
            {
                urlBuilder_.Append(System.Uri.EscapeDataString("originalQuery") + "=").Append(System.Uri.EscapeDataString(ConvertToString(originalQuery, System.Globalization.CultureInfo.InvariantCulture))).Append("&");
            }
            urlBuilder_.Length--;
        ...
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task ExternalCallbackPOSTAsync(string remoteError, string originalQuery)
        {
            return ExternalCallbackPOSTAsync(remoteError, originalQuery, System.Threading.CancellationToken.None);
        }

        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task ExternalCallbackPOSTAsync(string remoteError, string originalQuery, System.Threading.CancellationToken cancellationToken)
        {
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/connect/authorize/callback?");
            if (remoteError != null)
        ...
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public System.Threading.Tasks.Task ExternalCallbackGETAsync(OpenIdAuthorizationClientExternalCallbackGETParametersDto parameters)
        {
            return ExternalCallbackGETAsync(parameters, System.Threading.CancellationToken.None);
        }
    ...
    public partial class TestDataClient : BaseClient, ITestDataClient
    {
        ...
        /// </summary>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<string> PatchAsync(TestPatchDto dto)
        {
        ...
        /// </summary>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<string> PatchAsync(TestPatchDto dto, System.Threading.CancellationToken cancellationToken)
        {
            if (dto == null)
                throw new System.ArgumentNullException("dto");
